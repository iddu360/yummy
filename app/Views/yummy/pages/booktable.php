...
<section id="book-a-table" class="book-a-table pt-5 mt-5">
  <div class="container" data-aos="fade-up">
    ...
    <div class="row g-0">
      ...
      <div class="col-lg-8 d-flex align-items-center reservation-form-bg">
        ...
        if ($session->getFlashdata('booking-success')) {
        ?>
          <div class="alert alert-success alert-dismissible fade show my-3">
            <button type="button" class="btn-close" data-bs-dismiss="alert"> </button>
            <?= $session->getFlashdata('booking-success'); ?>
          </div>
        <?php
        }
        if ($session->getFlashdata('booking-failed')) {
        ?>
          <div class="alert alert-danger alert-dismissible fade show my-3">
            <button type="button" class="btn-close" data-bs-dismiss="alert"> </button>
            <?= $session->getFlashdata('booking-failed'); ?>
          </div>
        <?php
        }
        ?>
